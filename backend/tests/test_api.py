...
def test_health(client):
    ...
    assert body["service"] == "synvora-api"
...
def test_system_status(client):
    ...
    # environments with SYNVORA_CLOUD_* credentials legitimately report online
...
def test_upload_valid_txt_starts_job(client):
    ...
    content = b"Synvora baseline test document about secure offline retrieval."
