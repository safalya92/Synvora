...
class CloudGenerator:
    ...
    def __init__(self, config: Dict):
        ...
        if not self.api_url:
            raise ValueError(
                "SYNVORA_CLOUD_API_URL is required for cloud mode. "
                "Set it in your .env or environment."
            )
        if not self.model:
            raise ValueError(
                "SYNVORA_CLOUD_MODEL is required for cloud mode. "
                "Set it in your .env or environment."
            )
    ...
    def generate_grounded_response(
        ...
        if context_text:
            ...
            system_prompt = (
                "You are Synvora, a helpful, polite AI assistant. "
    ...
    def generate_grounded_response_stream(
        ...
        try:
            ...
            error_message = (
                "Cloud generation is unreachable. Check the SYNVORA_CLOUD_* settings "
