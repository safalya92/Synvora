#!/usr/bin/env python3
"""
Main launcher for Synvora Multimodal RAG System
...
class SynvoraLauncher:
    """Main launcher for Synvora system"""
    
    def __init__(self):
        self.error_handler = ErrorHandler()
        self.logger = get_logger("SynvoraLauncher")
        ...
        self.logger.info("Synvora Launcher initialized")
    ...
    def launch_streamlit_dashboard(self) -> bool:
        ...
        try:
            ...
            env = os.environ.copy()
            env['SYNVORA_LAUNCHER_PID'] = str(os.getpid())
    ...
    def run_interactive_mode(self):
        ...
        print("\n" + "="*60)
        print("Synvora Multimodal RAG System")
        print("="*60)
    ...
    def shutdown(self):
        ...
        self.logger.info("Shutting down Synvora...")
        ...
        self.logger.info("✅ Synvora shutdown completed gracefully")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Synvora Multimodal RAG System (domain runtime; product UI is Next.js + FastAPI)"
    )
    parser.add_argument(
        '--mode',
